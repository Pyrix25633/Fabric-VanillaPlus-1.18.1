...
public class ModBlocks {
    ...
    public static final Block BIRCH_TABLE = registerWoodBlock("birch_table",
            new ModTableBlock(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block HOLLOW_BIRCH_LOG = registerWoodBlock("hollow_birch_log",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block STRIPPED_HOLLOW_BIRCH_LOG = registerWoodBlock("stripped_hollow_birch_log",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    //Acacia
    ...
    public static final Block JUNGLE_TABLE = registerWoodBlock("jungle_table",
            new ModTableBlock(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block HOLLOW_JUNGLE_LOG = registerWoodBlock("hollow_jungle_log",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block STRIPPED_HOLLOW_JUNGLE_LOG = registerWoodBlock("stripped_hollow_jungle_log",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    //Dark Oak
    ...
    public static final Block DARK_OAK_TABLE = registerWoodBlock("dark_oak_table",
            new ModTableBlock(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block HOLLOW_DARK_OAK_LOG = registerWoodBlock("hollow_dark_oak_log",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block STRIPPED_HOLLOW_DARK_OAK_LOG = registerWoodBlock("stripped_hollow_dark_oak_log",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    //Crimson
    ...
    public static final Block CRIMSON_TABLE = registerWoodBlock("crimson_table",
            new ModTableBlock(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block HOLLOW_CRIMSON_STEM = registerWoodBlock("hollow_crimson_stem",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block STRIPPED_HOLLOW_CRIMSON_STEM = registerWoodBlock("stripped_hollow_crimson_stem",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    //Warped
    ...
    public static final Block WARPED_TABLE = registerWoodBlock("warped_table",
            new ModTableBlock(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block HOLLOW_WARPED_STEM = registerWoodBlock("hollow_warped_stem",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
    public static final Block STRIPPED_HOLLOW_WARPED_STEM = registerWoodBlock("stripped_hollow_warped_stem",
            new HollowLog(FabricBlockSettings.of(Material.WOOD)
                    .strength(woodHardness, woodResistance)
                    .sounds(BlockSoundGroup.WOOD).nonOpaque()));
